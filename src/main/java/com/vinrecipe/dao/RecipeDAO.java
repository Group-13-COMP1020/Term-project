...
public class RecipeDAO {
    ...
    public int insert(Recipe recipe) throws SQLException {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            // Robust fallback query for SQLite last insert row ID
    ...
    public void saveRecipeForUser(int userId, int recipeId) throws SQLException {
    ...
    public void unsaveRecipeForUser(int userId, int recipeId) throws SQLException {
    ...
    public boolean isRecipeSavedByUser(int userId, int recipeId) throws SQLException {
        String sql = "SELECT 1 FROM saved_recipes WHERE user_id = ? AND recipe_id = ?";
        Connection conn = DatabaseConnection.getInstance();
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setInt(1, userId);
            stmt.setInt(2, recipeId);
    ...
    public List<Recipe> findSavedRecipesByUser(int userId) throws SQLException {
        List<Recipe> recipes = new ArrayList<>();
        String sql = "SELECT r.* FROM recipes r "
